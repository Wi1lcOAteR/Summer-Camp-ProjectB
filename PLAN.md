...
| G-03 | Fresh-agent cold start and implementation approval | formal writing-plans evidence, G-01 PASS, G-02A/B/C PASS | G | [ ] 尚未执行；Superpowers 已安装并启用，但这条安装前 task 无正式 `writing-plans` 调用能力，须在新 task 闭合 D-001 |
